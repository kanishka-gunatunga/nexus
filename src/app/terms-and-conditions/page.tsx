          ...
          <div className="max-w-7xl mx-auto px-8 sm:px-6 md:px-10 lg:px-18 lg:-mt-28 md:-mt-28">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    ...
                    to NEXUS for Carriage, the receipt, pickup, loading,
                    carriage, transportation, customs clearance where
                    applicable, warehousing, holding, storage, unloading and
                  ...
                  <li>
                    ...
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        all legal fees, costs and disbursements incurred by
                        NEXUS or its Sub-Contractors in enforcing or in any
                        other way connected with this Agreement;
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        Sub-contractor whilst rendering the Services or in any
                        way related to the Services or the Goods;
                      </li>
                  ...
                  <li>
                    ...
                    not limited to any action, claim, demand, allegation,
                    threat, suit, or cause of action:
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      <li>
                      ...
                      <li>
                        in tort (including, but not limited to,
                      ...
                      <li>
                        alleging any act, including but not limited to
                        intentional acts with the apprehension of the
                        consequences, or any omission, whether unlawful or not.
                      </li>
                    </ul>
                  </li>
                  <li>
                    <span className="font-medium">Dangerous Goods:</span> means
                    Goods that are or may become noxious, dangerous,
                    inflammable, unstable, explosive, incendiary, corrosive or
                    damaging, or which are or may become liable to damage any
                    other Goods or property.
                  </li>
                  <li>
                    <span className="font-medium">Damages:</span> bears the
                    ...
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        judgement, award, penalty, fine, impost, duty,
                        proceeding or Claim;
                      </li>
                      ...
                      <li>
                        ...
                        damages (all including without limitation loss of
                        profit, loss of market, loss of goodwill, loss of
                        contract, loss of business, depletion of goodwill and
                        like loss).
                      </li>
                    </ul>
                  </li>
                  <li>
                    <span className="font-medium">Goods:</span> means the
                    property and things from time to time accepted by NEXUS from
                    or on behalf of the Shipper for Carriage and/or services and
                    includes any container or packaging.
                  </li>
                  <li>
                    <span className="font-medium">GST Law:</span> means the same
                    as in the A New Tax System (Goods and Services Tax) Act
                    1999.
                  </li>
                  <li>
                    <span className="font-medium">GST Rate:</span> means the
                  ...
                  <li>
                    ...
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        obligations to deliver up or otherwise deal with any
                        Goods or property;
                      </li>
                  ...
                  <li>
                    <span className="font-medium">NEXUS:</span> means NEXUS
                    LOGIX PTY LTD (ABN 82 682 875 154).
                  </li>
                  <li>
                    <span className="font-medium">Person:</span> means any
                    individual, partnership, firm, corporation, association,
                    trust, unincorporated organisation, or other entity,
                  ...
                  <li>
                    ...
                    quality, value, usefulness, or condition and includes
                    without limitation, foodstuffs, fruits, vegetables, dairy
                    products, meat, and the like.
                  </li>
                  <li>
                    <span className="font-medium">Service(s):</span> means the
                    Carriage of the Goods or property, as well as any other
                    related or ancillary acts, operations and services
                    undertaken or rendered by NEXUS, its agents or its
                    Sub-contractors or any Person (whether gratuitously or not).
                  </li>
                  <li>
                    <span className="font-medium">Shipper:</span> includes one
                    or more of:
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      <li>
                        the shipper, consignor, addressee, sender, recipient,
                        bailor, bailee, possessor, owner, importer and/or
                  ...
                  <li>
                    ...
                    <ul className="list-decimal list-inside ml-4 mt-2 space-y-1">
                      <li>
                        any Person, firm or company with whom NEXUS may arrange
                        to effect any Service or Carriage or part thereof in
                        respect of any Goods;
                      </li>
                      <li>
                        any other Person, firm or company that is now or
                        hereafter a servant, agent, employee or sub-contractor
                        of any of the Persons or entities referred to in (a).
                      </li>
                    </ul>
                  </li>
                  <li>
                    <span className="font-medium">Supply:</span> means the same
                    as in the GST Law.
                  </li>
                  <li>
                    <span className="font-medium">Taxable Supply:</span> means
                    any Supply under this Agreement in respect of which NEXUS is
                    or may become liable to pay GST.
                  </li>
                </ul>
              </section>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    NEXUS is not a Common Carrier and will not accept liability
                    as such.
                  </li>
                  <li>
                    All Goods are Carried, and all Services are rendered by
                    NEXUS subject only to this Agreement.
                  </li>
                  <li>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-[lower-alpha] list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    the Shipper has the authority of all Persons owning or
                    having any interest in the Goods to enter into this
                    Agreement and to give NEXUS instructions in relation to the
                    Goods;
                  </li>
                  <li>
                  ...
                  <li>
                    any information, descriptions, values or any other
                    particulars provided in respect of the Goods are accurate
                    and true;
                  </li>
                  <li>
                    the Shipper has complied and the Goods do and will comply
                    with all applicable laws and government regulations of any
                    country to, from, through or over which the Goods may be
                    carried, including those relating to packaging, Carriage,
                    storage, clearance, customs, import, export, delivery or
                    other Services in respect of the Goods;
                  </li>
                  <li>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    NEXUS and any Sub-contractors may at their sole discretion,
                    as principal or as agent for the Shipper, sub-contract on
                    any terms the whole or part of the Carriage of the Goods
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    The manner and route of Carriage and provision of the
                    Services is solely at the discretion of NEXUS or its
                    Sub-contractors.
                  </li>
                  <li>
                    If the shipper expressly or impliedly instructs NEXUS to
                    use, or it is expressly or impliedly agreed that NEXUS will
                    use a particular method of handling or storing the Goods or
                    a particular method or route of Carriage, NEXUS may employ
                    that method but if it cannot conveniently be adopted by
                    NEXUS in its sole discretion, the Shipper hereby authorises
                    NEXUS to handle, store or to Carry the Goods and/or to
                    render the Services as NEXUS in its sole discretion sees
                    fit.
                  </li>
                  <li>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    If required by NEXUS the Shipper must accurately complete
                    and deliver to NEXUS or its agents any declaration form
                    showing particular of Goods, values, weights, and any other
                    information the form requires to be completed.
                  </li>
                  <li>
                    NEXUS reserves the right at the cost and risk of the
                    Shipper, but is not required, to open and inspect any
                    package or Goods tendered to it and/or accepted for
                    Carriage.
                  </li>
                </ul>
              </section>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    NEXUS will be conclusively presumed to have completed
                    Carriage of the Goods and/or rendering of the Services if at
                    that address it obtains from any Person a receipt or signed
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    The Goods are at the sole risk of the Shipper and not of
                    NEXUS or any Sub-contractor.
                  </li>
                  <li>
                    The Shipper undertakes and warrants that neither NEXUS nor
                    any Sub-contractor or any other Person who Carries the Goods
                    or renders any Service at any time will in any circumstances
                    (except where any statute otherwise requires) suffer or
                    subject to:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>any Claim;</li>
                      <li>
                        any Liability relating to any Damages or other loss in
                        any way connected with Carriage, Services, the Goods or
                        otherwise arising.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        all Persons who are or might be vicariously liable for
                        the acts or omissions of any Person falling within (a)
                        or (b).
                      </li>
                    </ul>
                    NEXUS is or will be deemed to be acting as agent or Trustee
                    on behalf of and for the benefit of each of the other
                    persons benefiting from any Limitation of Liability under
                    this Agreement and all such Persons and each of them will to
                  ...
                  <li>
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        every other Person (other than NEXUS) by whom the
                        Services or any part thereof is undertaken;
                      </li>
                      <li>
                        all Persons who are or might be vicariously liable for
                        the acts or omissions of any Person falling within (a),
                  ...
                  <li>
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        Each Limitation of Liability in this Agreement is
                        separate and independent from other provisions and
                        limitations of Liability and each Limitation of
                        Liability survives termination of this Agreement for any
                        reason.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    statute, international convention or otherwise, the
                    Liability of NEXUS, no matter how arising, is limited to:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>
                        the lesser of (at NEXUS&apos;s sole discretion):
                        <ul className="list-[lower-roman] list-inside ml-4 mt-2 space-y-1">
                          <li>
                            payment received by NEXUS in relation to the
                            relevant Services;
                          </li>
                          <li>
                            the value of the Goods the subject of the Services
                            at the time the Goods were received by or for NEXUS;
                          </li>
                  ...
                  <li>
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>
                        to the extent that the TPA is applicable to this
                        Agreement and prevents the exclusion, restriction,
                        limitation or modification of such warranty or Liability
                        for any breach thereof;
                      </li>
                      <li>
                        only to the minimum extent required and imposing the
                        least liability on NEXUS required under the TPA.
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    ...
                    Sub-Contractors harmless in respect of any Claim made
                    against it by any Person in connection with any liability or
                    other loss arising or purportedly arising out of or relating
                    to:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                  ...
                  <li>
                    ...
                    indemnify and hold harmless NEXUS and its Sub-Contractors
                    from of all Liability and Claims:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>
                        in respect any duties, taxes, imposts, outlays or
                        charges at any port or place in respect of the Goods;
                      </li>
                      <li>
                        all customs and/or excise duties, costs, fines or
                        penalties imposed for any reason whatsoever in relation
                        to or connected with the Goods, Carriage or the
                        Services;
                      </li>
                      <li>pursuant to any applicable laws or regulations;</li>
                      <li>
                        the Claims of any Person (other than the Shipper) based
                        on real or purported interest in the Goods or parts of
                        them;
                      </li>
                      <li>
                        arising out of a breach of any warranty given by the
                        Shipper or the person who tendered the Goods to NEXUS
                        for Carriage;
                      </li>
                      <li>
                        arising out of the Carriage of any Dangerous Goods
                        whether declared as such or not and whether or not the
                        Shipper was aware of the nature of the Good;
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    or Liability arising from or under this Agreement,
                    performance of the Services, Carriage of the Goods, or any
                    property, howsoever caused.
                  </li>
                  <li>
                    Nothing in this clause 9 will limit or prejudice any
                    Limitation of liability contained in any other clause of
                    this Agreement. Each and every Limitation of Liability in
                    this Agreement is separate, cumulative, and severable and
                    available to both NEXUS, its Sub-contractors and any other
                    person involved in the Services or Carriage of the Goods.
                  </li>
                  <li>
                    ...
                    directors, employees, consultants, servants, agents,
                    officers, and advisors.
                  </li>
                  <li>
                    Every indemnity granted under this Agreement means not only
                    to indemnify and hold harmless, but also to keep
                  ...
                  <li>
                    ...
                    parties and survives termination of this Agreement for any
                    reason.
                  </li>
                </ul>
              </section>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    The Shipper is advised to seek its own insurance cover.
                  </li>
                  <li>
                    ...
                    declaration pursuant to clause 6.1 prior to acceptance of
                    the Goods by NEXUS and subject to NEXUS&apos;s right to
                  ...
                  <li>
                    ...
                    exceptions and conditions of policies of the insurance
                    company or underwriter taking the risk.
                  </li>
                  <li>
                    Subject to 10.1:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>
                        ...
                        NEXUS will not be under any obligation to effect
                        separate insurance on each consignment but may, at its
                        sole discretion, declare it on any general policy.
                        Should the insurer dispute liability for any reason, the
                        Shipper as insured will have no recourse whatsoever
                        against and forever releases NEXUS from all such
                        Liability and Claims and any recourse by the Shipper
                        will be against the insurer only;
                      </li>
                      <li>
                        ...
                        policy on the terms and conditions of the relevant
                        policy, and is subject to acceptance and payment of any
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    NEXUS may, at its sole discretion, as the Shipper&apos;s
                    agent or as principal, advance any duties, taxes, imposts,
                    outlays or charges at any port or place in respect of the
                    Goods and their Carriage.
                  </li>
                  <li>
                    The Shipper will pay all duties, taxes, imposts, outlays,
                    charges, costs, fines or penalties which NEXUS or its
                    Sub-Contractors become liable to pay for any reason
                    whatsoever in respect of the Goods, Carriage and/or the
                    Services and any documentation relating to the Goods
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    NEXUS&apos;s Charges will be considered earned as soon as
                    the Goods are received by NEXUS and are under no
                  ...
                  <li>
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        amounts in respect of all Claims or Liability incurred
                        by NEXUS for any reason in relation to the Carriage of
                        the Goods, the Services, the Goods, and/or this
                        Agreement.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    that Charges will be paid by the consignee or any other
                    Person will be deemed to include stipulation that:
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      <li>
                        the Shipper and the other person are jointly and
                  ...
                  <li>
                    ...
                    brokerages, commissions, allowances, and other remuneration
                    in respect of the Carriage of the Goods and/or the Services.
                    NEXUS and the Shipper agree that NEXUS need not make any
                    disclosure whatsoever to any person generally or in relation
                    to any specific instance of payment and is entitled to
                    retain these payments without any obligation to grant any
                    refunds or rebates.
                  </li>
                  <li>
                    The Shipper agrees that it will not exercise or purport to
                    exercise any right of set-off against, or defer, withhold,
                    or deduct by way of counterclaim or otherwise any sum from
                    any amount due to NEXUS by reason of any Claim it may allege
              ...
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    ...
                    relating to these other goods or cargo are accepted subject
                    to a general lien for all Charges now due or which may
                    hereafter become due to NEXUS or its Sub-contractors by the
                    Shipper on any account whatsoever, whether in respect of the
                    Goods now Carried, or in respect of any other Goods for
                    which NEXUS provides or has provided Services or Carriage.
                  </li>
                  <li>
                    Subject to clause 13.3, if any charges are not paid to NEXUS
                    within 1 month after notice of a lien has been given, the
                    detained Goods may be sold by NEXUS at its discretion and
                    the proceeds of the sale will be applied firstly to the
                    costs of storage and sale and then towards the satisfaction
                    of any outstanding Charges or any other sums owing to NEXUS,
                    appropriated as NEXUS in its sole discretion sees fit.
                  </li>
                  <li>
                    In the case of Goods that NEXUS determines are Perishable,
                    the Goods may be sold immediately without notice to the
                    Shipper.
                  </li>
                  <li>
                    NEXUS and its Sub-contractors will be entitled at the cost,
                    risk and expense of the Shipper or any other person having
                    an interest in the Goods, subject to any compliance with the
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        Goods that are not collected or accepted by the
                        consignee;
                      </li>
                      <li>
                        any Perishable goods which in the opinion of NEXUS or
                        the Sub-contractor appear to be deteriorating;
                      </li>
                      <li>
                        Goods in respect of which the person liable for Charges
                        under this Agreement fails to pay any costs and/or
                        Charges necessary to implement the Shipper&apos;s
                        instructions.
                      </li>
                    </ul>
                  </li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    ...
                    or are liable to become a risk, the relevant Goods may at
                    any time be destroyed, disposed of, abandoned or rendered
                    harmless without compensation to the Shipper or any other
                    person and without prejudice to NEXUS&apos;s right to any
                    Charges.
                  </li>
                  <li>
                    ...
                    packaged in a manner adequate to withstand the ordinary
                    risks of Carriage having regard to their nature.
                  </li>
                </ul>
              </section>
            </AnimatedSection>
              ...
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    ...
                    technical and product information, business systems;
                    logistics plans; rights in confidential information
                    (including know-how and trade secrets) and any other
                    intellectual property rights, in each case whether
                    registered, registrable or unregistered and including all
                    applications (or rights to apply) for, and renewals or
                  ...
                  <li>
                    ...
                    of Goods, all the resulting Intellectual Property Rights
                    vest solely in NEXUS and to the extent necessary, even
                    despite termination of this Agreement for any reason, the
                    Shipper irrevocably undertakes to assign in the manner
                    prescribed by NEXUS, all Intellectual Property Rights
                    exclusively to NEXUS so that NEXUS is exclusive owner of
                    those rights and irrevocably appoints NEXUS as its attorney
                    to execute all document and do all things necessary to bring
                    about such assignment.
                  </li>
                  <li>
                    For the purposes of this Clause 15, it does not matter
                    whether the Intellectual Property was created before or
                    after this Agreement.
                  </li>
                  <li>
                    Without limiting clauses 15.1, 15.2, 15.3 or 15.4, the
                    ...
                    <ul className="list-[lower-alpha] list-inside ml-4 mt-2 space-y-1">
                      ...
                      <li>
                        ...
                        in these Documents which will remain the sole property
                        of NEXUS and which are supplied to the Shipper under
                        license (the &quot;License&quot;) and subject to strict
                      ...
                      <li>
                        ...
                        <ul className="list-[lower-roman] list-inside ml-4 mt-2 space-y-1">
                          <li>
                            ...
                            directed by NEXUS and in relation to Carriage of
                            Goods or the rendering Services under this
                            Agreement;
                          </li>
                          <li>
                          ...
                          <li>
                            does not include the right on the part of the
                            Shipper or any other person to retain, use, copy,
                            duplicate, adapt or amend the Documents or to supply
                            them to any other person, save as directed in
                            writing by NEXUS.
                          </li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <ul className="list-[lower-roman] list-inside ml-4 mt-2 space-y-1">
                          ...
                          <li>
                            will deal with the Documents (including any copies)
                            as directed by NEXUS, including destruction or the
                  ...
                  <li>
                    Without limiting clauses 15.1, 15.2, 15.3 or 15.4, the
                    Shipper acknowledges and agrees that damages alone would not
                    be an adequate remedy for any breach by the Shipper or
                    persons acting through it of the provisions of this clause
                    15 and accordingly, without prejudice to any and all other
                    rights or remedies that NEXUS might have, NEXUS is entitled
                    without proof of special damage to the remedies of
                    injunction and other equitable relief for any threatened or
                    actual breach of the provisions of this clause 15.
                  </li>
                </ul>
              </section>
            </AnimatedSection>
              ...
              <section className="mb-8">
                ...
                <ul className="list-decimal list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  ...
                  <li>
                    ...
                    GST. In addition to such Charges, the Shipper must pay GST
                    on the Taxable Supply to NEXUS of an amount equal to the GST
                  ...
                  <li>
                    NEXUS will issue an invoice or Invoices to the Shipper for
                    the amount of GST referrable to the Taxable Supply. NEXUS
                    will include in any such Invoice the particulars that are
                    required by the GST Law so that the Shipper may obtain an
                    input tax credit for the amount of GST payable on the
                    Taxable Supply.
                  </li>
                  <li>
                    If any part of the consideration is referrable to both a
                    Taxable Supply and anything that is not a Taxable Supply,
                    the amount of GST payable by the Shipper will be determined
                    by NEXUS and will be the same amount of GST that would be
                    payable if the Taxable Supply were the only Supply made to
                    the Shipper.
                  </li>
                  <li>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-4 leading-relaxed">
                  The parties acknowledge and agree that if any provision or
                  part of any provision of this Agreement is unenforceable; such
                  unenforceability will not affect any other part or provision
                  of this Agreement. Without limiting any Limitation of
                  Liability under this Agreement, if NEXUS is unable to carry
                  out any obligation under this Agreement due to any
                  circumstances, matter or thing beyond its reasonable control
                  NEXUS will be excused from such obligations to the extent of
                  the prevention, restriction, or interference. In the event of
                  and to the extent of any inconsistency between these terms and
                  conditions and those incorporated into any bill of lading,
                  waybill, consignment note, any document of the Shipper or any
                  other transport document, these terms and conditions prevail.
                ...
                <ul className="list-[lower-alpha] list-inside text-xs sm:text-sm lg:text-base text-gray-600 space-y-2">
                  <li>
                    ...
                    warranty, or representation, express or implied has been
                  ...
                  <li>
                    ...
                    others, including without limitation, as to the
                    classification of or any matter material to the valuation of
                    or the liability for or the amount, scale or rate of customs
                    and/or excise duty or other impost, tax or rates charged in
                    respect of the Goods or any cargo whatsoever.
                  </li>
                </ul>
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 mt-4 leading-relaxed">
                  NEXUS will not be bound by any waiver or agreement purporting
                  to vary these terms and conditions unless such agreement is in
                  ...
                  arising from the Goods, Carriage of the Goods, or the
                  Services.
                </p>
              </section>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <section className="mb-8">
                ...
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-4 leading-relaxed">
                  ...
                  with any Special Conditions, the Special Conditions will
                  prevail to the extent of any conflict. Special Conditions
                  means written terms and conditions described as Special
                  Conditions which expressly amend this Agreement.
                </p>
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-4 leading-relaxed">
                  The Shipper agrees that all Carriage of Goods by NEXUS on
                  behalf of the Shipper from the date of signing of these
                  Conditions of Carriage will be on the terms and conditions
                  contained herein, unless otherwise agreed in writing by NEXUS.
                </p>
              </section>
            </AnimatedSection>
          </div>
