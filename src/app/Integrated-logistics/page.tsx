            ...
            <div className="relative top-[-100px] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <PhotoDescriptionSection
                        ...
                        subtitle="Think flexible warehousing is only for enterprise giants?"
                ...
                <div className="max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <PhotoDescriptionSection
                        ...
                        subtitle="Outsourced fulfilment won't cost you control..."
                ...
                <div className="max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <PhotoDescriptionSection
                        ...
                        subtitle="You don't need large stocks to minimize disruptions..."
                ...
                <div className="max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <PhotoDescriptionSection
                        ...
                        subtitle="Project cargo doesn't need to be an endless logistics headache..."
