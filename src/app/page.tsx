...
export default function Home() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setIsFading(true); // Start fading out
            setTimeout(() => {
                setCurrentMobileImageIndex((prevIndex) => (prevIndex + 1) % mobileImages.length);
                setIsFading(false); // Start fading in
            }, 500); // This duration should match your CSS transition duration
        }, 5000);
    ...
    return (
        <div className="min-h-screen bg-[#F6F6F6] poppins">
            ...
            <section className="relative mx-auto overflow-hidden max-w-[1800px]">
                ...
                <div id="hero-content"
                     className="relative hidden lg:block z-50 mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-24">
