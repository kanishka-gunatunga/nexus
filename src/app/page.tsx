      ...
      <section className="relative mx-auto overflow-hidden max-w-[1800px]">
        ...
        >
          <div className="absolute block inset-0">
            <div className="absolute flex flex-row justify-end right-0 w-[300px] sm:w-[400px] md:w-[500px] h-full hero-image">
              <Image
                ...
                width={1600}
                height={1600}
                className={`w-[100px] h-[100px] object-contain relative z-40 duration-500 ease-in-out ${
                  isFading ? "opacity-0" : "opacity-100"
                } hero-images
                            }`}
              />
