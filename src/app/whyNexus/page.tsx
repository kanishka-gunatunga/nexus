          ...
          <AnimatedSection direction="up" delay={0.5}>
            <div className="my-8 gap-4 flex flex-wrap justify-center px-0 sm:px-6 lg:px-8">
              <div className="group bg-white hover:bg-[#0F2043] transition-all duration-300 rounded-lg shadow p-5 sm:p-6 md:p-8 flex-1">
                ...
                <p className="lg:text-paragraph text-[14px] md:text-[18px] text-[#676767] group-hover:text-white font-poppins font-medium">
                  Manage Your Supply Chain with the World&rsquo;s Most trusted
                  ERP
                </p>
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-6  lg:pl-8  flex flex-col lg:flex-row justify-between items-center gap-8 vision-achievements">
              ...
              <div className="flex flex-col mb-4 w-full lg:w-2/3 px-2">
                ...
                >
                  ...
                  that is both personal and agile. Over nearly three decades,
                  our people&rsquo;s reputation for reliability and innovation
                  has enabled us to serve importers, exporters, and supply chain
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 px-8 sm:px-6 lg:px-8 mt-[50px] lg:mt-[100px]">
          <div className="w-full md:w-1/3 text-center md:text-left">
            ...
            <p className="text-[#676767] font-normal text-sm xs:text-base sm:text-lg mt-4">
              For nearly 30 years, we&apos;ve moved cargo (and some mountains)
              to achieve outstanding successes for our customers.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 lg:mt-8 mt-0">
            ...
            >
              ...
              <SwiperSlide>
                <div className="bg-white p-8 rounded-lg shadow">
                  <p className="text-[#676767] font-normal text-sm xs:text-base sm:text-lg leading-relaxed mb-4">
                    I appreciate how reliable Nexus Logix is. With them on
                    board, our timelines are met without surprises, and that
          ...
          <div className="flex-1 flex flex-col justify-center">
            <AnimatedSection direction="right" delay={0.2}>
              ...
              <p className="font-poppins font-semibold text-xl text-[#162F65] leading-[26px] mb-2">
                Moving Freight. Minimising Footprint. Or Moving Freight Towards
                a Greener Future or Moving Greener
              </p>
              ...
              <p className="font-poppins font-normal text-xs sm:text-sm lg:text-base text-[#676767] leading-relaxed text-justify md:text-left">
                At Nexus Logix, sustainability is a conscious mindset that
                drives every decision we make. As a majority Australian-owned
                company with a global footprint, we are committed to reducing
                our environmental impact while empowering our customers to do
                the same. Our approach integrates green strategies at every
                level - from the partners we choose and the technology we invest
                in, to the everyday practices that guide our operations.
              </p>
            </AnimatedSection>
          </div>
        </div>
