...
const airAndSeaFreight = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6] poppins">
      ...
      <div className="max-w-7xl block lg:hidden mx-auto mt-2 px-6 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 px-6 sm:px-6 lg:px-8 mt-[50px] lg:mt-[100px]">
