...
const Footer = () => {
  return (
    <footer className="bg-[#222222] text-white relative poppins overflow-hidden">
      <div className="relative">
        {/* Background pattern */}
        <div className="absolute bg-[url('/x.png')] bg-no-repeat -top-5 sm:-top-6 lg:-top-25 bg-contain overflow-hidden inset-0 w-full sm:w-3/5 lg:w-[550px] h-[800] opacity-5" />
        {/*<div className="absolute left-0 top-0 opacity-5">*/}
        {/*    <Image*/}
        {/*        src="/logo.png"*/}
        {/*        alt=""*/}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4 lg:py-8">
          {/* Top section */}
          <div className="flex flex-col items-center lg:flex-row lg:justify-between mt-6 mb-6 sm:mb-8 lg:mb-10">
            ...
            <button className="bg-white text-[#162F65] hover:bg-black hover:border-1 hover:border-white hover:text-white transition duration-300 px-6 py-2 sm:px-15 sm:py-3 text-base sm:text-lg lg:text-xl rounded-lg font-medium flex-shrink-0">
              Talk to Us
            </button>
          </div>
