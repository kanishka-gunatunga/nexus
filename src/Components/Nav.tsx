                ...
                <div className="flex items-center justify-between py-3 sm:py-4 lg:py-6 relative">
                    ...
                    <nav
                        ...
                        <Link href="#"
                            ...
                            <button
                                className="bg-[#e6b333] text-[#282828] hover:bg-[#e6b333]/90 px-4 sm:px-6 lg:px-8 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-sm rounded-lg font-normal transition-colors"
                            >
                                Track and Trace
                            </button>
                        </Link>
