    ...
    <>
      <div>
        <button
          ...
          className="fixed right-0 top-[60%] flex flex-col transform -translate-y-1/2 text-white font-semibold rounded-l-md tracking-widest text-xs sm:text-sm transition z-50 hover:shadow-lg"
        >
          <div
